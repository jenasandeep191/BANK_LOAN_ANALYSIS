...
- 📘 `BANK LOAN ANALYSIS.ipynb`: Jupyter notebook for loan risk analysis
...
SQL: Extract, Querying and aggregating loan data
Power BI: Interactive dashboards for stakeholders
Excel: Quick validation and reporting

🔍 Key Insights
- Loan performance segmented by status, employment length, and funded amount
- Identification of high-risk vs low-risk borrowers
- Analysis of interest rate vs debt-to-income (DTI)
- Dashboard for real-time monitoring of loan KPIs

📈 Business Value
This analysis helps financial institutions:
- Improve loan approval strategies
- Optimize risk management
- Enhance operational efficiency with data-driven dashboards
